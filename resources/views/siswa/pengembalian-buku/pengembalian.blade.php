...
<head>
    ...
    <style>
        ...
        .partikel {
            position: absolute; background: var(--accent-emerald); border-radius: 50%;
            opacity: 0; bottom: -20px; filter: blur(1px);
        ...
        .latar-animasi {
            position: fixed; top: 0; left: 0; width: 100%; height: 100%;
            z-index: -2; background: var(--latar-radial);
        }

        .container-main {
            width: 100%; max-width: 1200px; padding: 2rem;
            display: grid; grid-template-columns: 1fr 0.92fr; gap: 3.5rem;
        ...
        .title-huge {
            ...
            letter-spacing: -2px; margin-bottom: 1.2rem; color: var(--text-main);
        }
        ...
        .note-label { 
            ...
            color: var(--accent-warning); text-transform: uppercase; 
            letter-spacing: 1px; margin-bottom: 3px;
        }

        .badge-status {
            padding: 5px 12px; border-radius: 100px; font-size: 0.6rem; font-weight: 800; 
        ...
        .btn-luxe {
            background: var(--gradasi); color: #ffffff !important; border: none; padding: 1.1rem;
            border-radius: 18px; font-weight: 800; width: 100%; font-size: 0.95rem;
            display: flex; align-items: center; justify-content: center; gap: 12px;
            text-transform: uppercase; letter-spacing: 1.5px; transition: 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275);
        }
        ...
        .book-option {
            ...
            transition: 0.3s; background: var(--item-bg);
        ...
        .guide-number {
            width: 35px; height: 35px; background: var(--gradasi);
            border-radius: 12px; display: flex; align-items: center; justify-content: center;
            font-weight: 800; color: white; flex-shrink: 0; font-size: 0.9rem;
            ...
            <div class="control-panel">
                ...
                <form action="{{ route('pengembalian.update', 0) }}" method="POST" id="returnForm">
                    ...
                    <button type="submit" class="btn-luxe" id="submitBtn" disabled>
                        KONFIRMASI SEKARANG <i class="bi bi-send-fill ms-2"></i>
                    </button>
                </form>
                        ...
                        <div class="col-md-6">
                            <div class="guide-item">
                                ...
                                <div class="guide-text">
                                    <h6>Akses Akun</h6>
                                    <p>Login menggunakan NIS dan password yang sudah terdaftar.</p>
                                </div>
                            </div>
                            <div class="guide-item">
